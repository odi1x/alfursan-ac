    ...
    <>
      ...
      <header className="relative pt-[12vh] pb-[40px] px-0 overflow-hidden min-h-[580px] border-b border-line flex flex-col">
        ...
        <div className="relative z-10 w-[min(100%,1060px)] mx-auto px-[20px] flex flex-col items-center justify-center text-center flex-grow mt-[20px]">
          <Image className="w-[150px] sm:w-[180px] opacity-100 drop-shadow-xl mx-auto mb-[20px]" src="/assets/logo.png" alt="شعار أكاديمية همة الفرسان" width={180} height={288} priority />
          ...
          <h1 className="font-display font-[900] text-[clamp(2rem,6vw,2.5rem)] leading-[1.1] mb-[12px] text-white" dangerouslySetInnerHTML={{ __html: heroHeadline.replace('تتحقق', '<em class="text-academy-red not-italic">تتحقق</em>') }}>
          </h1>
          <p className="text-white font-display font-bold text-[clamp(2.2rem,8vw,3.5rem)] leading-[1.2] max-w-[600px] mx-auto mb-[36px] px-[10px] drop-shadow-md">
            {heroSubheading}
          </p>
